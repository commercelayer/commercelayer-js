...
module.exports = {
  ...
  selectSku: function(
    ...
    console.log('addVariantQuantityId :', addVariantQuantityId)
    ...
    clsdk.retrieveSku(skuId, qf.build()).then(data => {
      ...
      if (sku.inventory.available) {
        ...
        ui.enableAddVariantQuantity(addVariantQuantityId)
      } else {
        // TODO: disable quantity
        ui.disableAddToBag(addToBagId)
        ui.disableAddVariantQuantity(addVariantQuantityId)
      }
