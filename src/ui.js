...
module.exports = {
  ...
  updateVariantsQuantity: function(skus) {
    ...
    skus.forEach(function(sku) {
      let addVariantsQuantity = document.querySelectorAll(
        '.clayer-add-variant-quantity[data-sku-code="' + sku.code + '"]'
      )
  ...
  updateAddVariantQuantitySKU: function(
    ...
    skuImageUrl,
    skuMaxQuantity,
    addVariantQuantityId
  ) {
    let addVariantQuantity = document.querySelector(`#${addVariantQuantityId}`)
  ...
  updateAddToBagSKU: function(
    ...
    if (addToBag) {
      ...
      if (addVariantQuantityId)
        addToBag.dataset.addVariantQuantityId = addVariantQuantityId
    }
  },
  enableAddVariantQuantity: function(addVariantQuantityId) {
    let addVariantQuantity = document.querySelector(`#${addVariantQuantityId}`)
    if (addVariantQuantity) {
      enableElement(addVariantQuantity)
    }
  },
  disableAddVariantQuantity: function(addVariantQuantityId) {
    let addVariantQuantity = document.querySelector(`#${addVariantQuantityId}`)
    if (addVariantQuantity) {
      disableElement(addVariantQuantity)
    }
